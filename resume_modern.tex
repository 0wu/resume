...
%\familyname{Wu}
\title{}
%\address{40 S. Alcaniz St}{Pensacola, FL, U.S.A}
\phone{+1-858-436-4485}
...
%Seeking a full-time research / engineer position in the  MIT DARPA Robotic Challenge Team
Seek a full-time research / engineer position in the robotics / vision division.

\section{Technical Skills}
	\cvitem{programming}{Matlab, Java, Python, C/C++}
	\cvitem{robotics}{articulate body kinematics/dynamics modeling \& identification, reinforcement motor learning,    
		optimal control, optical motion capture, pneumatic/hydraulic/series elastic actuators, Robotic Operating System (ROS)}
	\cvitem{computer vision}{activity classification, facial expression analysis, support vector machines}
	%\cvitem{spoken languages}{English (proficient) Mandarin Chinese (native), Taiwanese (native)}
	%\cvitem{fabrication}{Solidworks, 3D printing, laser cutter, 8051, basic CNC, basic PCB}
	
\section{Professional Experience}
	\cventry{2013-present}{Postdoc Researcher}{}{P.I Jerry Pratt}{Florida Institute Human Machine Cognition (IHMC)}
	{
		\begin{itemize}
	...
	\cventry{2010-2013}{Research Assistant}{}{P.I. Javier Movellan, UCSD}{Emanuel Todorov, UW}
	{
	...
	\cventry{2007- 2010}{Research Assistant / Software Engineer}{}{P.I. Marian Bartlett}{UCSD/{\httplink[Emotient\homepagesymbol]{emotient.com}}}
	{
		\begin{itemize}
	...
	\cventry{2002 - 2004}{Undergraduate Research Assistant}{}{P.I. Chih-Jen Lin}{National Taiwan University}
	{
		\begin{itemize}
...
\section{Software}
\cventry{2012-2013}{ROS-Matlab-Bridge}{}{a library enabling writing ROS node in Matlab \httplink[\homepagesymbol(96$^+$ downloads)]{code.google.com/p/mplab-ros-pkg/wiki/java_matlab_bridge}}{}{}
